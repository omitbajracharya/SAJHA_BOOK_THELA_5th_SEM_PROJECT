 ...
 <div class="fluid-container">
  <section id="block">
    <div class="row no-gutters">
      ...
      $sql = "SELECT * FROM `message` WHERE 1 Limit 0, 20";
          ...
          if (mysqli_num_rows($result) > 0) {
            ...
            <tr>
              ...
              <td>
                ...
                <a style="color: #F00; text-decoration: none;" onclick="return confirm('Are you sure you want to delete this file?')" href="messagedel.php?id=<?= $row['message_no'];?>">&#10008;</a>
              </td>
            </tr>
            <?php
          }   
