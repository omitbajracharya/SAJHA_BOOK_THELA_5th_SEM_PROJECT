    ...
    <section id="block">
      <div class="row no-gutters">
        ...
        // Check connection
          ...
          $sql = "SELECT * FROM `seller_transaction` WHERE 1 Limit 0, 20";
          $result = mysqli_query($conn, $sql);
      // $data = mysqli_num_rows($result);
      // echo "<pre>"; print_r($result); exit();
          ?>
          <h1>Sell Transcation List</h1>
              ...
              while($row = mysqli_fetch_assoc($result)) {
               ...
               <tr>
                ...
                <td>
                  ...
                  <a style="color: #F00; text-decoration: none;" onclick="return confirm('Are you sure you want to delete this file?')" href="selltrandel.php?id=<?= $row['transcation no'];?>">&#10008;</a>
                </td>
              </tr>
              <?php
            }   
